...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="absolute left-0 right-0 md:left-[27%] md:right-[27%] top-0 h-[22vh] -z-0 pointer-events-auto">
        <FooterBackground />
      ...
      {/* Content Section */}
      <div className="ml-0 mr-0 md:ml-[27%] md:mr-[27%] pt-[calc(22vh+112px)] pb-0 px-8 md:px-4 flex flex-col z-10 relative">
        {/* Form */}
