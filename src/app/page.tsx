...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
      ...
      {/* Cell 1: Banner */}
      <div className="absolute left-0 right-0 md:left-[27%] md:right-[27%] top-0 h-[22vh] -z-0 pointer-events-auto overflow-hidden bg-white dark:bg-black shadow-[0_4px_12px_rgba(2,6,23,0.04)] dark:shadow-[0_4px_12px_rgba(2,6,23,0.10)]">
        <img
      ...
      <div className="absolute left-0 right-0 md:left-[27%] md:right-[27%] top-[22vh] h-[112px] flex items-center px-4 z-50">
      ...
      <div className="ml-0 mr-0 md:ml-[27%] md:mr-[27%] pt-[calc(22vh+112px)] pb-0 px-4 flex flex-col z-10 relative min-h-screen">
